...
<table width="1010" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td bgcolor="#FFFFFF"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        <td><a href="https://plus.google.com/u/0/101740367695515335148/"><img width="100%" height="130" src="banner.png"/></a></td>
      </tr>
      <tr>
            ...
            <tr valign="top">
              ...
              <td width="193"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="style15"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td><img src="images/cart_bg1.jpg" width="100%" height="7" /></td>
                        </tr>
                        <tr>
				...
				?>
                        ...
                        <tr>
                          <td><img src="images/cart_bg2.jpg" width="100%" height="7" /></td>
                        </tr>
                    </table></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td class="style15"><table width="97%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="style17"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="3%"><img src="images/c_bg1.jpg" width="6" height="29" /></td>
      ...
      <tr>
        <td class="style24"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr valign="top">
              ...
              <td bgcolor="#126eb1" class="style25"><strong>Công ty TNHH Tin Học GearLeaf Center </strong><br>
                ĐỊA CHỈ: 391 Nam Kỳ Khởi Nghĩa, Quận 3, Thành Phố Hồ Chí Minh<br>
                Điện thoại: 0988 038 478</td>
